...
I'm an Embedded Systems Engineer interested in low-level programming, real-time systems, embedded Linux, and edge AI.

I have more than five years of professional experience in embedded software, hardware bring-up, communication protocols, and debugging on real devices. 

I enjoy understanding systems from registers and startup code all the way to RTOS applications, networking, and complete hardware-software architectures.
...
![Yocto](https://img.shields.io/badge/Yocto-5B32B4?style=flat-square)
![Xenomai](https://img.shields.io/badge/Xenomai-333333?style=flat-square)

### Interfaces and Tools

![CAN](https://img.shields.io/badge/CAN-1F6FEB?style=flat-square)
...
![I2C](https://img.shields.io/badge/I%C2%B2C-555555?style=flat-square)
...
Outside work, I enjoy experimenting with development boards, repurposing old hardware, and building open-source embedded projects. I am always working on something. If I don't post, might mean I am working on something private!
